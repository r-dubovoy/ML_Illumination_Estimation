...
x = float(sys.argv[argv_start + 1])
y = float(sys.argv[argv_start + 2])
z = float(sys.argv[argv_start + 3])
...
bpy.context.scene.render.filepath = root + 'training/blender/render_single/layers_upd/{} {} {} {}'.format(x, y, z, name)
